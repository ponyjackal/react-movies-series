...
const cStyles = {
  ...
  headerTop:
    "flex flex-row justify-between bg-blue-600 py-5 pl-10 md:pl-36 lg:pl-56 pr-10 shadow-xl",
  headerTitle:
  ...
  freeTrial:
    "font-sans text-base md:text-lg lg:text-xl text-white bg-gray-800 px-2 py-1 hover:bg-gray-700",
  headerBottom:
    "flex flex-row justify-between bg-gray-700 py-3 pr-10 pl-10 md:pl-36 lg:pl-56 shadow-xl",
  subTitle:
